...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='D:/PointNet++Test/data/shapenetcore_partanno_segmentation_benchmark_v0_normal', help='dataset path')
    ...
    root = 'D:/PointNet++Test/data/shapenetcore_partanno_segmentation_benchmark_v0_normal'
